...
//  * @Date: 2018-04-16 10:10:31 
//  * @Last Modified by:   Atilla Tanrikulu 
//  * @Last Modified time: 2018-04-16 10:10:31 
//  */
...
// {
//     public class BaseRepositoryPostgreSQL<TEntity> : IRepository<TEntity> where TEntity : class
//     {
...
//         public BaseRepositoryPostgreSQL(DbConnection connection) => init(connection, 0);
//         public BaseRepositoryPostgreSQL(DbConnection connection, int userId) => init(connection, userId);

//         public BaseRepositoryPostgreSQL(DbConnection connection, string user_Id)
//         {        
...
//             if (result == 1)
//             {
//                 result = Connection.ExecuteScalar<long>("SELECT last_insert_rowid()");
//             }
